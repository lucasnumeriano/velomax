...
/** Margem esquerda do componente em relacao a tela (left-[34px] no index). */
...
/**
 * Exibe Trip A (distancia) e velocidade media em uma unica linha
...
export function TripInfo({
  ...
  return (
    <View style={{ width: svgW, height: CURVE_H + 40 }}>
      ...
      <View
        className="absolute flex-row items-center justify-between px-1 w-[420px]"
        style={{ top: CURVE_H + 6 }}
      >
        {/* Trip A */}
        <View className="flex-row items-center gap-2">
          <Text className={`text-3xl ${textClass}`}>Trip A</Text>
